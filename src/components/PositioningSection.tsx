    ...
    <section id="comparison" ref={sectionRef} className="py-20 md:py-28 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-4">
          ...
          <h2 className="reveal text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 font-display" style={{ transitionDelay: '.08s' }}>{t.positioning.title}</h2>
          <p className="reveal text-slate-500 text-base" style={{ transitionDelay: '.14s' }}>{t.positioning.subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
          ...
          <div className="reveal-left bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm text-left">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
              <div>
                <span className="text-xs font-bold text-slate-400 uppercase font-mono">{lang === 'ru' ? 'Традиционные методы' : 'Traditional Methods'}</span>
                <h3 className="text-xl font-black text-slate-900 font-display mt-0.5">{lang === 'ru' ? 'Рынок сегодня' : 'Market Today'}</h3>
              </div>
          ...
          {/* TestTop AI */}
          <div className="reveal-right bg-white p-6 sm:p-8 rounded-3xl border-2 shadow-xl text-left relative overflow-hidden"
            style={{ borderColor: '#F97316', boxShadow: '0 20px 40px -10px rgba(249,115,22,0.15)' }}>
            ...
            <div className="flex items-center justify-between border-b border-orange-100 pb-4 mb-6 relative z-10">
              <div>
                <span className="text-xs font-bold text-orange-600 uppercase font-mono">{lang === 'ru' ? 'Будущее экзаменов' : 'The Future of Prep'}</span>
                <h3 className="text-xl font-black text-slate-900 font-display mt-0.5">TestTop AI</h3>
              </div>
              <span className="flex items-center gap-1.5 px-3 py-1 brand-gradient text-white text-xs font-bold rounded-full shadow-sm font-mono">
            ...
            <div className="space-y-3 relative z-10">
              {[
                ...
                <div key={i} className="flex items-start gap-3 p-3.5 rounded-2xl bg-orange-50/50 border border-orange-100 hover:border-orange-300 transition-colors">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden reveal mb-10">
          ...
          {comparisonRows.map((row, i) => (
              ...
              <div className="col-span-4 text-xs text-orange-700 font-semibold flex items-center justify-center text-center px-2">
                <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-orange-500 shrink-0" />{row.testTopAI}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="reveal rounded-3xl border-2 border-orange-400 bg-orange-50/50 p-7 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm" style={{ transitionDelay: '.2s' }}>
          <div className="flex items-center gap-4 text-left">
            <div className="w-12 h-12 rounded-2xl brand-gradient text-white flex items-center justify-center shadow-lg brand-glow shrink-0">
          ...
          <span className="px-5 py-2.5 brand-gradient text-white font-mono font-bold text-xs uppercase tracking-widest rounded-xl shadow-sm whitespace-nowrap neon-pulse">
            AI-First Approach
          </span>
        </div>
      </div>
